...
func Test_searchInsert_2(t *testing.T) {
	require.Equal(t, 2, searchInsert_2([]int{1, 3, 5, 6}, 5))

	require.Equal(t, 1, searchInsert_2([]int{1, 3, 5, 6}, 2))

	require.Equal(t, 4, searchInsert_2([]int{1, 3, 5, 6}, 7))

	require.Equal(t, 0, searchInsert_2([]int{1, 3, 5, 6}, 0))

	require.Equal(t, 0, searchInsert_2([]int{1}, 0))
}
