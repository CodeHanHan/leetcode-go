...
func Test_removeElement2(t *testing.T) {
	require.Equal(t, 0, removeElement2([]int{}, 1))

	require.Equal(t, 0, removeElement2([]int{1}, 1))

	require.Equal(t, 2, removeElement2([]int{3, 2, 2, 3}, 3))

	require.Equal(t, 1, removeElement2([]int{1, 1, 2}, 1))

	require.Equal(t, 8, removeElement2([]int{0, 0, 1, 1, 1, 2, 2, 3, 3, 4}, 0))
}
